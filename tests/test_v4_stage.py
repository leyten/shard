...
def stage_from_oracle(oracle, args, lo, hi, *, head=None, tail=None, dspark=False, fast=False):
    ...
    st = V4.Stage(lo, hi, args, head=head, tail=tail, dspark=dspark, device="cpu", fast_verify=fast)
